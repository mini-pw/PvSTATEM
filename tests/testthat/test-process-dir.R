...
test_that("Test finding layout file", {
  plate_filepath <- system.file("extdata", "CovidOISExPONTENT_CO.csv", package = "SerolyzerR", mustWork = TRUE) # get the filepath of the csv dataset
  random_plate_filepath <- system.file("extdata", "random_intelliflex.csv", package = "SerolyzerR", mustWork = TRUE) # get the filepath of the csv dataset
  layout_filepath <- system.file("extdata", "CovidOISExPONTENT_CO_layout.xlsx", package = "SerolyzerR", mustWork = TRUE)
...
test_that("Test checking for mba file", {
  ...
  plate3_filepath <- system.file("extdata", "random_intelliflex.csv", package = "SerolyzerR", mustWork = TRUE) # get the filepath of the csv dataset
  non_matched_filepath <- system.file("extdata", "random.csv", package = "SerolyzerR", mustWork = TRUE) # get the filepath of the csv dataset
  layout_filepath <- system.file("extdata", "CovidOISExPONTENT_CO_layout.xlsx", package = "SerolyzerR", mustWork = TRUE)
...
test_that("Test obtaining an output directory", {
  plate_filepath <- system.file("extdata", "multiplate_mock", "other", "random2_xponent.csv", package = "SerolyzerR", mustWork = TRUE) # get the filepath of the csv dataset
...
test_that("Test processing a mock directory", {
  dir <- system.file("extdata", "multiplate_mock", package = "SerolyzerR", mustWork = TRUE) # get the filepath of the csv dataset
...
test_that("Test processing a directory with a single plate", {
  dir <- system.file("extdata", "multiplate_lite", package = "SerolyzerR", mustWork = TRUE) # get the filepath of the csv dataset
...
test_that("Test processing a reallife directory with merge output", {
  dir <- system.file("extdata", "multiplate_reallife_reduced", package = "SerolyzerR", mustWork = TRUE) # get the filepath of the csv dataset
  output_dir <- tempdir(check = TRUE)
