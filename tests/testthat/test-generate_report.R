...
test_that("Test generate_plate_report function with no arguments", {
...
test_that("Test generate_plate_report function with specified lower and higher thresholds", {
  plate <- get_test_plate()
  expect_no_error(generate_plate_report(plate, counts_lower_threshold = 40, counts_higher_threshold = 80))
})

test_that("Test generate_levy_jennings_report function with no arguments", {
