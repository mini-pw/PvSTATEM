...
<style>
  ...
  /* Active (clicked) plot border */
  .plot-container.active {
    border-color: rgba(0, 0, 0, 0.65);
    box-shadow: 0 0 10px rgba(0, 0, 0, 0.4), /* Initial shadow */
            0 0 20px rgba(0, 0, 0, 0.2); /* Larger and softer*/
  }
