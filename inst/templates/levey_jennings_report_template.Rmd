...
First plate was run on: `r if(!is.null(date_of_first_plate)) format(date_of_first_plate, "%d-%m-%Y %H:%M:%S") else "Date of running plate was not found in Luminex file"`.  
Last plate was run on: `r if(!is.null(date_of_last_plate)) format(date_of_last_plate, "%d-%m-%Y %H:%M:%S") else "Date of running plate was not found in Luminex file"`.  
Time span: `r if(!is.null(time_span)) paste0(time_span, " days") else "Dates were not found in Luminex file"`.
