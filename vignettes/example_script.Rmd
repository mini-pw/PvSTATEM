...
For instance, if we plotted the standard curve for the analyte `ME` we could notice that the `Median` value of sample with dilution of `1/25600` is abnormally large, which may indicate a problem with the data.
...
plot_standard_curve_analyte_with_model(plate, analyte_name = "OC43_S", model, log_scale = c("all"))
plot_standard_curve_analyte_with_model(plate, analyte_name = "OC43_S", model, log_scale = c("all"), plot_asymptote = FALSE)
```
