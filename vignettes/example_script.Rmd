...
```{r}
plot_standard_curve_analyte(plate, analyte_name = "Spike_6P_IPP")
...
```{r}
plot_standard_curve_analyte(plate, analyte_name = "RBD_wuhan_IPP", data_type = "Mean")
plot_standard_curve_analyte(plate, analyte_name = "RBD_wuhan_IPP", data_type = "Avg Net MFI")
```
...
```{r}
model <- create_standard_curve_model_analyte(plate, analyte_name = "Spike_6P_IPP")
...
```{r}
plot_standard_curve_analyte_with_model(plate, analyte_name = "Spike_6P_IPP", model)

plot_standard_curve_analyte_with_model(plate, analyte_name = "Spike_6P_IPP", model, log_scale = c("dilutions"))
```

Apart from the plotting, the package can predict values of all the samples on the plate.

```{r}
mfi_values <- plate$data$Median$Spike_6P_IPP
head(mfi_values)
