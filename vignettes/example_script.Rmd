...
Since our `model` object is an instance of `nplr` class, it contains all the information about the fitted model. The model can be used to predict the dilutions of the samples, based on the MFI values.
