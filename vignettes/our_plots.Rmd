...
This plot is proper for quickly spotting wells with a count that needs to be higher.
...
The default plot type is violin, but the option is to change it to violin plot by setting the `plot_type` parameter to `boxplot`.
