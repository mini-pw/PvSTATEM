...
First one disables drawint the line between standard curve points, second one disables plotting the mean of blank samples, and the last one disables plotting the dilution bounds.
