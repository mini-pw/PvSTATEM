---
title: "Introduction to plots created by our package"
author: "Mateusz Nizwantowski"
date: "`r Sys.Date()`"
vignette: >
  %\VignetteIndexEntry{Introduction to plots created by our package}
...
The `SerolyzerR` package provides a variety of plots that can be used to visualize the Luminex data. In this vignette, we will show how to use them. 
...
plate_filepath <- system.file("extdata", "CovidOISExPONTENT.csv", package = "SerolyzerR", mustWork = TRUE) # get the filepath of the csv dataset
