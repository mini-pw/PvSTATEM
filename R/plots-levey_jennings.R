...
#' @param data_type (`character(1)`) the type of data used plot. Default is "Median"
#'
#' @return A ggplot object with the Levey-Jennings chart
#'
#' @export
plot_levey_jennings <- function(list_of_plates, analyte_name, sd_lines = c(1.96), data_type="Median") {
